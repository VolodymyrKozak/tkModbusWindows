...
//    //= = //= = //= = //= = //= = Мастера с ЧП //= = //= = //= = //= = кон.
//
//    if(K4>=4)                                      //задержка передачи после сброса
//     {}//подготовка к передаче и передача Модему }
//     }
//   n3:i1=0;
//    l2=0; //сброс количество принятых байтов
//    if((!(l1))&&(K5&0x01))
...
//          SBUFtx[2]=27;   //Количество байт в регистрах
//          SBUFtx[3]=0;
...
//          }
//      /*
//        //==//==//==//==//==Подготовка ответа по функции 105 ==//==//==//==//нач
//         if(Funk_Mod==105)
//          {SBUFtx[1]=Funk_Mod;  //Функция
//           SBUFtx[2]=TKA_MB;    //Режим работы текущий
//           SBUFtx[3]=TaskMB_RAD;    //Задание текущее
//           SBUFtx[4]=St_Driv;  //Cостояние мотора
//           SBUFtx[5]=KTZ;       //Защита (наличие аварии)
//           SBUFtx[6]=VU; //Значение верхнего уровня (ВУ)
//           SBUFtx[7]=NU; //Значение нижнего уровня (НУ)
//           SBUFtx[8]=SU; //Значение уровня сухой ход(СХ)или средний уровень(CУ)
//           Hold_Reg[0]=IndArray[0]; //I1
//           Hold_Reg[1]=IndArray[1]; //I2
//           Hold_Reg[2]=IndArray[2]; //I3
//           Hold_Reg[3]=arr[ver_prj]; //версия проекта
//           Hold_Reg[4]=TimeCode105; //счетчик обменов
//            //Выполнить перестановку местами байтов для Hold_Reg
//            // и записать их в SBUFtx, начиная SBUFtx[10], т.е.
//           i2=9;i3=5;
//           for(i4=0;i4<i3;i4++)
...
//             SBUFtx[i2+1]=Temp2%256;i2=i2+2;}
//            }
//            //==//==//==//==//==Подготовка ответа по функции 105 ==//==//==//==//кон
//         */
//            //==//==//==//==//==Подготовка ответа по функции 106 ==//==//==//==//нач
//           if(Funk_Mod==106)
//            {SBUFtx[1]=Funk_Mod;  //Функция
...
//// while (!(IFG1 & UTXIFG0)){if(!(TXEPT))/*{i++;if(i==280)*/{ME1&=~UTXE0;P3OUT&=~0x80;}}//}
////            l5=i1/256;l6=i1%256;
